...
//       {forecast && <Forecast data={forecast} />}
//       <h1 id="appName">Welcome to Weather Now</h1>
//       <p id="appDesc">Weather Now puts the power of instant weather forecasting at your fingertips. 
//       With a simple and clean interface, you'll get the 
//       most up-to-date weather information for your city, all in a glance.
//       Enter a city name to the search box and select the city. 
//       You will get all the weather information for your city up to 7 days!
//       </p>
//     </div>
//   );
// }
